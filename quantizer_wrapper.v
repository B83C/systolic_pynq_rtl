...
module quantizer_wrapper #(
    ...
    input  wire                                  mul_q_wen,
    input  wire [$clog2(MAX_MUL_Q+1)-1:0]        mul_q_wdata,
    input  wire                                  shift_wen,
    input  wire [$clog2(MAX_SHIFT+1)-1:0]        shift_wdata,
    input  wire                                  zp_out_wen,
    input  wire [$clog2(MAX_ZP_OUT-MIN_ZP_OUT+1)-1:0] zp_out_wdata,
